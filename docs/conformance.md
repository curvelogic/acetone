...
> refreshed 2026-07-24 (for 0.3.1) by running the runner on `main`.

## Pass rate

**1602 / 3897 scenarios pass (41.1%).**

| Area | Scenarios | Passing | Rate |
|------|-----------|---------|------|
| expressions | 2616 | 1097 | 41.9% |
| clauses | 1251 | 505 | 40.4% |
| useCases | 30 | 0 | 0.0% |
...
|---------|-------|---------|
| **passed** | 1602 | executed and produced the TCK-expected result |
...
| **failed** | 50 | acetone rejects a query the TCK requires to be valid, or returns a wrong result |

"Unsupported" outcomes are **honest declines**, not wrong answers: acetone
reports a typed "not supported" rather than mis-executing. The 50 **failures**
