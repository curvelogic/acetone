...
- **Phase start** (working agreement, Greg 2026-07-24; recorded here 2026-08-01): agents claim a phase's implementation beads only after Greg has explicitly opened the phase. Between boundaries sessions do spec and grooming — discussion, ADRs, homing beads into epics — without implementing; a ratified design decision is not a start signal.
